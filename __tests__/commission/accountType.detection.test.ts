...
describe('Account Type UI Colors', () => {
  describe('getAccountTypeColor', () => {
    test('Anchor should return green color', () => {
      expect(getAccountTypeColor('Anchor')).toBe('#16a34a');
    });

    test('Bread5 should return blue color', () => {
      expect(getAccountTypeColor('Bread5')).toBe('#2563eb');
    });

    test('Bread15 should return purple color', () => {
      expect(getAccountTypeColor('Bread15')).toBe('#7c3aed');
    });

    test('Pit should return red color', () => {
      expect(getAccountTypeColor('Pit')).toBe('#dc2626');
    });
  });

  describe('getAccountTypeBgColor', () => {
    test('Anchor should return light green background', () => {
      expect(getAccountTypeBgColor('Anchor')).toBe('#dcfce7');
    });

    test('Bread5 should return light blue background', () => {
      expect(getAccountTypeBgColor('Bread5')).toBe('#dbeafe');
    });

    test('Bread15 should return light purple background', () => {
      expect(getAccountTypeBgColor('Bread15')).toBe('#ede9fe');
    });

    test('Pit should return light red background', () => {
      expect(getAccountTypeBgColor('Pit')).toBe('#fee2e2');
    });
  });
});
...
describe('Default Thresholds', () => {
  test('DEFAULT_THRESHOLDS should have expected values', () => {
    ...
    expect(DEFAULT_THRESHOLDS.anchorMinRevenueGreenline).toBe(100);
    expect(DEFAULT_THRESHOLDS.bread5MaxMinutes).toBe(5);
    expect(DEFAULT_THRESHOLDS.bread15MaxMinutes).toBe(15);
    expect(DEFAULT_THRESHOLDS.milesPerMinute).toBe(0.5);
  });
});
