...
const ss = StyleSheet.create({
  ...
  sectionHeader: {
    ...
    backgroundColor: '#f8fafc', borderLeftWidth: 3, borderLeftColor: Colors.primary, marginBottom: Spacing.xs,
  },
  ...
  numberInputRow: {flexDirection: 'row', alignItems: 'center', gap: Spacing.xs},
  numberInput: {flex: 1, backgroundColor: Colors.surface, borderWidth: 1.5, borderColor: Colors.border, borderRadius: Radius.md, paddingHorizontal: Spacing.md, paddingVertical: Spacing.sm, fontSize: FontSize.md, color: Colors.textPrimary},
  prefixText: {fontSize: FontSize.md, color: Colors.textSecondary, fontWeight: '600', minWidth: 16},
  suffixText: {fontSize: FontSize.sm, color: Colors.textMuted},
  selectChips: {flexDirection: 'row', flexWrap: 'wrap', gap: Spacing.sm},
  selectChip: {paddingHorizontal: Spacing.md, paddingVertical: 6, borderRadius: Radius.full, borderWidth: 1, borderColor: Colors.border, backgroundColor: Colors.surface},
  selectChipActive: {backgroundColor: Colors.primary, borderColor: Colors.primary},
  selectChipText: {fontSize: FontSize.sm, color: Colors.textSecondary, fontWeight: '500'},
  ...
  toggleRow: {flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: Spacing.lg, paddingVertical: Spacing.sm},
  toggleInfo: {flex: 1, gap: 2},
  toggleSub: {fontSize: FontSize.xs, color: Colors.textMuted},
  calcRow: {paddingHorizontal: Spacing.lg, paddingVertical: Spacing.sm, gap: Spacing.xs},
  calcLabel: {fontSize: FontSize.sm, fontWeight: '600', color: Colors.textSecondary},
  calcFields: {flexDirection: 'row', alignItems: 'center', gap: Spacing.sm},
  calcInput: {flex: 1, backgroundColor: Colors.surface, borderWidth: 1.5, borderColor: Colors.border, borderRadius: Radius.md, paddingHorizontal: Spacing.sm, paddingVertical: Spacing.sm, fontSize: FontSize.sm, color: Colors.textPrimary, textAlign: 'center'},
  calcInputReadOnly: {backgroundColor: '#f8fafc', borderColor: Colors.borderLight, color: Colors.textMuted},
  calcAt: {fontSize: FontSize.sm, color: Colors.textMuted, fontWeight: '600'},
  calcTotal: {flex: 1, backgroundColor: '#f0fdf4', borderRadius: Radius.md, paddingHorizontal: Spacing.sm, paddingVertical: Spacing.sm, alignItems: 'center'},
  calcTotalText: {fontSize: FontSize.sm, fontWeight: '700', color: '#065f46'},
  dollarRow: {flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: Spacing.lg, paddingVertical: Spacing.sm},
  dollarRowHighlight: {backgroundColor: Colors.primaryLight, borderRadius: Radius.md, marginHorizontal: Spacing.lg, paddingHorizontal: Spacing.md},
  dollarLabel: {fontSize: FontSize.sm, color: Colors.textSecondary, fontWeight: '500', flex: 1, marginRight: Spacing.sm},
  dollarLabelHighlight: {color: Colors.primary, fontWeight: '700'},
